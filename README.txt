...
stream of node teasers by pressing "n" several times. Then scroll back to the
previous article by pressing "p".
...
and users will be able to navigate that stream by pressing "n" and "p" as well.
